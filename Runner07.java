...
public class Runner07 {
    public static void main(String args[]) {
        Polygon p = new Polygon();         // error because no default constructor // does not make sense
        ...
        Rectangle r = new Rectangle();    // also an error due to no default constructor
            System.out.println("numSides in Rectangle: " + r.numSides);  // this does not make sense
